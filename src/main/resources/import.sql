...
INSERT INTO `currency` (`code`, `name`, `rate`, `description`, `lastupdate`) VALUES ('USD', '美金', 18924.6666, null, NULL);
INSERT INTO `currency` (`code`, `name`, `rate`, `description`, `lastupdate`) VALUES ('GBP', '英鎊', 15812.7777, null, NULL);
INSERT INTO `currency` (`code`, `name`, `rate`, `description`, `lastupdate`) VALUES ('EUR', '歐元', 18434.8888, null, NULL);
INSERT INTO `currency` (`code`, `name`, `rate`, `description`, `lastupdate`) VALUES ('CNY', '人民幣', 40202.9999, null, NULL);
